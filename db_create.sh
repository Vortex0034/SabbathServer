#!/bin/bash
sql3="CREATE USER rufus WITH PASSWORD 'rufus_password';"
psql -U postgres -c "$sql3"
...
sql4="GRANT ALL ON SCHEMA public TO rufus;
GRANT ALL ON ALL TABLES IN SCHEMA public TO rufus;
ALTER SCHEMA public OWNER TO rufus;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO rufus;
GRANT ALL ON ALL FUNCTIONS IN SCHEMA public TO rufus;"
psql -U postgres -d sabbath -c "$sql2"
psql -U postgres -d sabbath -c "$sql4"
